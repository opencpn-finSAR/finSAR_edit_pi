...
finSAR_editUIDialogBase::finSAR_editUIDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_button11 = new wxButton( m_panelRoutes, wxID_ANY, _("New"), wxDefaultPosition, wxDefaultSize, 0 );
	m_button11->SetBackgroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_INACTIVECAPTION ) );

	bSizer9->Add( m_button11, 0, wxALL|wxEXPAND, 5 );

	m_button112 = new wxButton( m_panelRoutes, wxID_ANY, _("Save"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_button1122 = new wxButton( m_panelRoutes, wxID_ANY, _("Save As..."), wxDefaultPosition, wxDefaultSize, 0 );
	m_button1122->SetBackgroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_INACTIVECAPTION ) );

	bSizer9->Add( m_button1122, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );

	m_button1121 = new wxButton( m_panelRoutes, wxID_ANY, _("Import"), wxDefaultPosition, wxDefaultSize, 0 );
	m_button1121->SetBackgroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_INACTIVECAPTION ) );

	bSizer9->Add( m_button1121, 0, wxALL|wxEXPAND, 5 );

	m_button11211 = new wxButton( m_panelRoutes, wxID_ANY, _("Export"), wxDefaultPosition, wxDefaultSize, 0 );
	m_button11211->SetBackgroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_INACTIVECAPTION ) );

	bSizer9->Add( m_button11211, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
	...
	m_staticText1 = new wxStaticText( m_panelExtensions, wxID_ANY, _("Extensions File"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText1->Wrap( -1 );
	bSizer8->Add( m_staticText1, 0, wxALL, 5 );

	m_textExtName = new wxTextCtrl( m_panelExtensions, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_button1122->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( finSAR_editUIDialogBase::OnSaveRouteAs ), NULL, this );
	m_button1121->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( finSAR_editUIDialogBase::OnImportRoute ), NULL, this );
	m_button11211->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( finSAR_editUIDialogBase::OnExportRoute ), NULL, this );
	...
	m_mRoutes->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( finSAR_editUIDialogBase::OnImportRoute ), this, m_mImportRoute->GetId());
	m_mRoutes->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( finSAR_editUIDialogBase::OnDeleteRoute ), this, m_mDeleteRoute->GetId());
...
finSAR_editUIDialogBase::~finSAR_editUIDialogBase()
{
	...
	m_button1122->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( finSAR_editUIDialogBase::OnSaveRouteAs ), NULL, this );
	m_button1121->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( finSAR_editUIDialogBase::OnImportRoute ), NULL, this );
	m_button11211->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( finSAR_editUIDialogBase::OnExportRoute ), NULL, this );
...
MyOpsFrame::MyOpsFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	m_button14 = new wxButton( this, wxID_ANY, _("Show"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer3->Add( m_button14, 0, wxALL, 5 );

	m_button15 = new wxButton( this, wxID_ANY, _("Hide"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer3->Add( m_button15, 0, wxALL, 5 );

	m_button16 = new wxButton( this, wxID_ANY, _("EBL"), wxDefaultPosition, wxDefaultSize, 0 );

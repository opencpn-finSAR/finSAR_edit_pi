...
/// Class MyOpsFrame
///////////////////////////////////////////////////////////////////////////////
class MyOpsFrame : public wxFrame
{
	private:
	...
	public:
		...
		MyOpsFrame( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("finSAR Operations"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
